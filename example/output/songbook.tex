...
\hypersetup{
  ...
  linkcolor=.,
  urlcolor=blue,
  pdfcreator=bard v. 1.0.1 - https://github.com/vojtechkral/bard,
}
...
\Verse{Ch.1.} \Chord{G7}{But~come~ye~}\Chord{Am}{back~when~}\Chord{F}{summer’s~}\Chord{G7}{in~the~}\Chord{C}{meadow}\\
...
\Verse{Ch.2.} And~I~shall~hear,~though~soft~you~tread~above~me\\
